    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-2xl bg-purple-700 hover:bg-purple-800 text-white font-bold text-xs shadow-sm transition-all shrink-0"
        >
      ...
      {/* Users Table */}
      <div className="app-card rounded-3xl overflow-hidden border-slate-200 shadow-sm">
                ...
                <tr key={u.id} className="hover:bg-slate-50/60 transition-colors">
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {u.store_name && (
                          <div className="text-[11px] text-amber-700 font-medium">{u.store_name}</div>
                        )}
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="p-4">
                    <select
                      ...
                      className="px-2.5 py-1.5 rounded-xl bg-white border border-slate-200 text-xs text-slate-900 font-medium focus:outline-none focus:border-purple-600 cursor-pointer"
                    >
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/40 backdrop-blur-sm overflow-y-auto">
          <div className="relative w-full max-w-lg bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 space-y-5 shadow-2xl my-8">
            <div className="flex items-center gap-3 pb-3 border-b border-slate-100">
              ...
              <div>
                <h4 className="text-base font-bold text-slate-900">Create New Platform User</h4>
                <p className="text-xs text-slate-500">Provision a new account with custom role permissions</p>
              </div>
            </div>
            ...
            <form onSubmit={handleCreateSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-900 focus:outline-none focus:border-purple-600 focus:bg-white"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">MoMo Network</label>
                  <select
                    value={momoProvider}
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1.5">MoMo Number</label>
                  <input
                    type="tel"
                    value={momoNumber}
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 rounded-xl bg-purple-700 hover:bg-purple-800 text-white text-xs font-bold shadow-sm"
                >
                  Create User
                </button>
              </div>
